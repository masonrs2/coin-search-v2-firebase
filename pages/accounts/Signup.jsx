        ...
        <div className="w-full h-full bg-black px-6 text-gray-400" >
            <div className="flex flex-col text-black justify-center items-center h-screen rounded-md shadow-lg bg-black">
                <div className="flex flex-col sm:border rounded-md items-center">
                    ...
                    <h1 className="text-2xl font-semibold py-4 items-center justify-center text-center lg:text-3xl text-purple-400" >Sign Up</h1>
                    <p className="w-[500px] px-8 text-gray-500">Create you Crypto CoinSearch account with your personal email to interact with our products at greater scale.</p>
                        ...
                        <form onSubmit={handleSubmit} >
                            ...
                            className="border border-gray-200/50 py-4 text-md h-10 px-[13.5px] flex mt-6 mb-4 rounded-md w-[430px] outline-none text-gray-400  bg-gray-800/60 font-light" />

                            <input 
                            onChange={(e) => setPassword(e.target.value)}
                            type="password"
                            placeholder='Enter your password'
                            className="border border-gray-200/50 py-4 text-md h-10 px-[13.5px] flex mt-1 mb-4 rounded-md w-[430px] outline-none text-gray-400  bg-gray-800/60 font-light" />
